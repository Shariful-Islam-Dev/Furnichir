...
const Footer = () => {
  return (
    <>
      <section className='bg-[#2c96d3] footer'>
        <div className="container md:w-5/6 px-2 md:px-0 mx-auto py-7">
            <div className='grid md:grid-cols-4 grid-cols-1 justify-center gap-10 pt-8'>
              <div className='flex flex-col'>
              <a href="/" className="text-4xl text-white font-bold font-Playfair">Furniture</a>
                <p className='text-md text-gray-300 md:mt-8 md:mb-20 my-4'>625 E Franklin Ave, Minneapolis,   MN 55404, USA</p>
                <p className='text-md text-gray-300'>@ 2022 <a className='underline' href="https://shariful152019-portfolio.web.app/">Shariful Islam</a>. All rights reserved.</p>
              </div>
              <div>
                <div>
              ...
              <div>
                  ...
                  <ul  className='flex flex-col md:gap-5 gap-2'>
                    <li className='flex gap-5 text-md text-gray-300 items-center'>
                        ...
                        <span><a href="tel:+2 666327232147">+21 123456978</a></span>
                    </li>
                    <li className='flex gap-5 text-md text-gray-300 items-center'>
                        <span><a href="/.com"> <HiOutlineMail className='text-2xl' /></a></span>
                        <span><a href="/.com">shariful152019@gmail.com</a></span>
                    </li>
                    <li className='flex gap-5 text-md text-gray-300 items-center my-6 ml-3'>
                        <span><a href="/.com"> <FaFacebookF className='text-2xl' /></a></span>                        
                        <span><a href="/.com"><AiFillLinkedin className='text-2xl'/></a></span>
                        <span><a href="/.com"><BsInstagram className='text-2xl'/> </a></span>
                        <span><a href="/.com"><AiOutlineTwitter className='text-2xl'/></a></span>
                    </li>
                  </ul>
                </div>
              </div>
